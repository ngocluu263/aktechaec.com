...
namespace Controller
{
    public class Function
    {
        ...
        public string Getbanner(object Banner_type, object banner_field, object Banner_ID, object Banner_Image)
        {
            ...
            return banner == "1" ? "<p class='brand'><a href='/'>" + GetImage(Banner_type, Banner_ID, Banner_Image) + "</a></p>" : "<p class='brand-name'> " + GetImagebanner(Banner_type, Banner_ID, Banner_Image) + "</p>";
        }
